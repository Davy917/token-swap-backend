from app_sqlalchemy import app, db, Pool, PoolReserve
...
with app.app_context():
    ...
    if existing_pool:
        ...
        new_pool = Pool(last_updated_time=datetime.now().isoformat())
...
這個概念現階段只需要記得「凡是要在 app.py 之外操作 SQLAlchemy，都要包一層 app.app_context()」，之後用多了自然會有感覺。
